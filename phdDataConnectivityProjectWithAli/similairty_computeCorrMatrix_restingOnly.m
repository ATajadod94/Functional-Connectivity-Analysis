function similairty_computeCorrMatrix_restingOnly
...
load([maskDir,'subjVoxForEachROI_restingOnly.mat']); % load the data of included voxels for each subj
...
save([corrMatrixDir,'similarityData.mat'], 'similarityPerRoi',...
