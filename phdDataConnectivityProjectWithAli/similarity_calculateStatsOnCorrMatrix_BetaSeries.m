function similarity_calculateStatsOnCorrMatrix_BetaSeries
...
load([corrMatrixDir,'similarityDataUsingBetaSeries.mat']);
figOutPath = 'C:\Users\Zhongxu\Documents\myStudy\picpairfMRI\similarityAnalysis\corrMatrixData_EncodingResting\reultsFiguresBetaSeries\';
...
fam2_postfam_postnfam = ttestOnSimilarity(allData1,allData2,idx);
...
fam1_postfam_postnfam = ttestOnSimilarity(allData1,allData2,idx);
...
fam12_postfam_postnfam = ttestOnSimilarity(allData1,allData2,idx);
...
nfam12_postnfam_postfam = ttestOnSimilarity(allData1,allData2,idx);
...
fam12_postfam_postnfam_partialpre = ttestOnSimilarity(allData1,allData2,idx);
...
nfam12_postnfam_postfam_partialpre = ttestOnSimilarity(allData1,allData2,idx);
...
a= ttestOnSimilarity(allData1,allData2,idx);
...
fam1_postfam_nfam1_postnfam = ttestOnSimilarity(allData1,allData2,idx);
...
%
function outStats = ttestOnSimilarity(allData1,allData2,idx)
...
figOutPath = 'C:\Users\Zhongxu\Documents\myStudy\picpairfMRI\similarityAnalysis\corrMatrixData_EncodingResting\resultsFigures_BetaSeries\';
axisFontSize = 8;
