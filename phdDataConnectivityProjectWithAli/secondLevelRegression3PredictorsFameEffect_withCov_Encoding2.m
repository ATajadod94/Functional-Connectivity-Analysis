function secondLevelRegression3PredictorsFameEffect_withCov_Encoding2(isCovariate,memType)
% List of open inputs
...
for crun = 1:nrun
    inputs{1, crun} = {[rootDir,'secondLevelReg\multiRegSecondEncoding\fameEffect']};% Factorial design specification: Directory - cfg_files
    if ~exist([rootDir,'secondLevelReg\multiRegSecondEncoding\fameEffect'],'dir')
        mkdir([rootDir,'secondLevelReg\multiRegSecondEncoding\fameEffect']);
    end
