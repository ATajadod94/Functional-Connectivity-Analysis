function secondLevelRegression3PredictorsNonFamCond_withCov_Encoding2(isCovariate, memType)
% List of open inputs
...
for crun = 1:nrun
    inputs{1, crun} = {[rootDir,'secondLevelReg\multiRegSecondEncoding\NonFam']};% Factorial design specification: Directory - cfg_files
    if ~exist([rootDir,'secondLevelReg\multiRegSecondEncoding\NonFam'],'dir')
        mkdir([rootDir,'secondLevelReg\multiRegSecondEncoding\NonFam']);
    end
