function [yfam, ynfam fh sc fh_sc] = plotPicVsScrambleBarGraphs_anterioPosteriorHPC(isplot)
%to answer Morris question whether anterior posterior hpc showed different
%encoding fluency effect, i also checked whether the anterior/posterior
%difference also exist during encoding in general
if nargin<1
    isplot=1;
end
addpath C:\Users\Zhongxu\Documents\MATLAB\myMatLabTools\majorNeuroImagingTools\marsbar-0.43
famDir = 'C:\Users\Zhongxu\Documents\myStudy\picpairfMRI\secondLevelAnalysis\Fam1+Fam2\';
...
if isplot==1
    ...
    plotNotBoxPlot(yfam,figDir,'encodingapHPCvmPFC',2);
end
...
if isplot==1
    ...
    plotNotBoxPlot(ynfam,figDir,'encodingapHPCvmPFC',2);
end
