function ppi_wrapper_encodingSubsquentMemEff(regionnumber,firstsubject,lastsubject)
...
for i=firstsubject:lastsubject;
    ...
    subjPPIDir = [projDir,'s',sprintf('%03d',i),'\encoding\analysis-subsequentMemory\'];
    ...
    %contrast 2
    P.Contrasts(2).name = 'rem-nonrem-fm';
    P.Contrasts(2).left = {'Fam1_rem','Fam2_rem'};
    P.Contrasts(2).right = {'Fam1_notRem','Fam2_notRem'};
    ...
    P.Contrasts(3).right = {'NFam1_nonRem','NFam2_nonRem'};
      ...
      %contrast 4
    P.Contrasts(4).name = 'rem-nonrem-fm1';
    P.Contrasts(4).left = {'Fam1_rem'};
    P.Contrasts(4).right = {'Fam1_notRem'};
    
     
      %contrast 5
    P.Contrasts(5).name = 'rem-nonrem-fm2';
       P.Contrasts(5).left = {'Fam2_rem'};
    ...
    P.Contrasts(7).right = {'NFam2_nonRem'};
      ...
      P.Contrasts(8).name = 'rem-fm1-fm2';
    P.Contrasts(8).left = {'Fam1_rem'};
    P.Contrasts(8).right = {'Fam2_rem'}; 
    
        %contrast 9
    P.Contrasts(9).name = 'nonrem-fm1-fm2';
    P.Contrasts(9).left = {'Fam1_notRem'};
    P.Contrasts(9).right = {'Fam2_notRem'};
