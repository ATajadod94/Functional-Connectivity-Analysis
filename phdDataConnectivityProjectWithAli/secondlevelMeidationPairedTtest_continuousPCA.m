function secondlevelMeidationPairedTtest_continuousPCA
...
%             '\encoding\analysis-performancePmod-0\con_',sprintf('%04d',3),'.img'];    
%     dataFName{2,1}= [rootDir1,subjDir(includedSubj(n)).name,...
%             '\encoding\analysis-performancepcaPmod-10\con_',sprintf('%04d',3),'.img'];
...
for n = 1:20
       ...
       dataFName{1,1}=[rootDir1,subjDir(includedSubj(n)).name,...
            '\encoding\analysis-pcaPmod-10\con_',sprintf('%04d',3),'.img']; 
    dataFName{2,1}= [rootDir1,subjDir(includedSubj(n)).name,...
            '\encoding\analysis-performancepcaPmod-10\con_',sprintf('%04d',7),'.img'];
        % Factorial design specification: Scans - cfg_files
