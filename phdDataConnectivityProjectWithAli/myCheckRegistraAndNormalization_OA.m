function myCheckRegistraAndNormalization_OA(isubj,checkFlag)
%i subject id
...
facefMRIDCMDirectories = importDicomDirectoryExcel_OA('F:\myStudies\fixMTL_Old\Faces_fMRI_old\facefMRIDCMDirectories.xlsx');
dataDir = 'F:\myStudies\fixMTL_Old\Faces_fMRI_old_raw\';
[a ia ib]=unique(facefMRIDCMDirectories.subjID);
