function [p t baselineCorrGrpLR postFamCorrGrpLR postNonFamCorrGrpLR] = ...
    prepostNonFamEncodingCorr(subjID,isHemiLR,isControlCov,filterBand)
if nargin <4
    filterBand=[];
end
projDir = 'C:\Users\Zhongxu\Documents\myStudy\picpairfMRI\';
figOutPath = 'C:\Users\Zhongxu\Documents\myStudy\picpairfMRI\pre_postNonFam_EncodingCorr_5ROI\';
if isControlCov==1
    figOutPath = 'C:\Users\Zhongxu\Documents\myStudy\picpairfMRI\pre_postNonFam_EncodingCorr_ControlCov_5ROI\';
end
...
for i = 1:nRoi
    for j = 1:nRoi
        [a p(i,j) ci stats]=ttest(postNonFamCorrGrpLR(i,j,:),baselineCorrGrpLR(i,j,:));
...
s=figure;
figTitle = {['Post-Nonfamous vs Baseline correlations',hemiSide]};
...
set(gcf,'color','w');
colorbar;
export_fig([figOutPath,'PostNonFam_Baseline_',hemiSide],'-tiff','-r300');
...
export_fig([figOutPath,'PostNonFam_Baseline_diff_TvalFdr05_',hemiSide],'-tiff','-r300');
...
export_fig([figOutPath,'PostNonFam_Baseline_diff_TvalNoCrect_',hemiSide],'-tiff','-r300');
