function SecondLevelROIMarsbarAnalysisGeneral_functionalROI(rootDir)

marsbar('on')

% You might want to define the path to the example data here, as in
% subjroot = '/my/path/somewhere';
maskDir = 'C:\Users\Zhongxu\Documents\myStudy\picpairfMRI\masks\functionalRois';
...
%         end
        ...
        save([fullfile(contrastDir,'marsbarROIAnalysisFunctionalRois.mat')], 'marsS');
    end
    clear marsS;
end
