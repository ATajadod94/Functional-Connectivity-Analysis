function subjVox = similairty_deleteOutsideVoxel_restingOnly
...
for subj = 1:20
    ...
    subjVox(subj).deletedVox= emptyVoxResting{subj,:};
    includedVox = allvox;
 ...
 outDir = 'C:\Users\Zhongxu\Documents\myStudy\picpairfMRI\similarityAnalysis\corrMatrixData_EncodingResting\'; 
    ...
    save([outDir,'subjVoxForEachROI_restingOnly.mat'],'subjVox');
