function [p t famCorrGrpLR nonfamCorrGrpLR] = ...
    EncodingCorr5ROIs(subjID,dataName,isHemiLR,isControlCov,filterBand)
if nargin <4
    filterBand=[];
end
projDir = 'C:\Users\Zhongxu\Documents\myStudy\picpairfMRI\';
figOutPath = 'C:\Users\Zhongxu\Documents\myStudy\picpairfMRI\EncodingCorr_5ROI\';
if isControlCov==1
    figOutPath = 'C:\Users\Zhongxu\Documents\myStudy\picpairfMRI\EncodingCorr_ControlCov_5ROI\';
end
...
for i = 1:length(subjDir)
    ...
    [fam1CorrGrpL(:,:,i),fam1CorrGrpR(:,:,i),fam1CorrGrpLR(:,:,i)] = ...
        computeCorr(fam1,FisherTrans, isDetrend,numTR,filterBand);
    
    [fam2CorrGrpL(:,:,i),fam2CorrGrpR(:,:,i),fam2CorrGrpLR(:,:,i)] = ...
        computeCorr(fam2,FisherTrans, isDetrend,numTR,filterBand);
    
    [nonfam1CorrGrpL(:,:,i),nonfam1CorrGrpR(:,:,i),nonfam1CorrGrpLR(:,:,i)] = ...
        computeCorr(nonfam1,FisherTrans, isDetrend,numTR,filterBand);
    
    [nonfam2CorrGrpL(:,:,i),nonfam2CorrGrpR(:,:,i),nonfam2CorrGrpLR(:,:,i)] = ...
        computeCorr(nonfam2,FisherTrans, isDetrend,numTR,filterBand);
...
%*************************************************************************
function [corrL, corrR, corrLR]= computeCorr(data,FisherTrans, isDetrend,numTR,filterBand)
