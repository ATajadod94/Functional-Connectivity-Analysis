function secondLevelRegression3PredictorsFamCond_withCov_Encoding1(isCovariate,memType)
% List of open inputs
...
for crun = 1:nrun
    inputs{1, crun} = {[rootDir,'secondLevelReg\multiRegFirstEncoding\Fam']};% Factorial design specification: Directory - cfg_files
    if ~exist([rootDir,'secondLevelReg\multiRegFirstEncoding\Fam'],'dir')
        mkdir([rootDir,'secondLevelReg\multiRegFirstEncoding\Fam']);
    end
