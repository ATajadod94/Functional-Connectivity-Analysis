function firstlevelSubsequentMemoryAnalysisBasic(subID,analysisName,dataName,isFamOnly)
% List of open inputs
...
for crun = 1:nrun
    ...
    inputs{1, crun} = {[FUNCDIR,'\analysis-',analysisName,'\']}; % fMRI model specification: Directory - cfg_files
