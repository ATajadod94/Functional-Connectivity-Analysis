function secondLevelEncodingStrategyGroupComparisonRegress_PPI_HPC
...
dataSubDir = 'encoding\analysis\PPI_L_HPC\';
for contr = 1:length(allContrastNum)
contrastNum=allContrastNum(contr); % contrast from first level univariate analysis

outputPath = ['secondLevelReg\singleReg\encodingStrategyBinaryRegress_PPI_L_HPC\',allContrastNames{contr}];
...
dataSubDir = 'encoding\analysis\PPI_R_HPC\';

for contr = 1:length(allContrastNum)
contrastNum=allContrastNum(contr); % contrast from first level univariate analysis

outputPath = ['secondLevelReg\singleReg\encodingStrategyBinaryRegress_PPI_R_HPC\',allContrastNames{contr}];
contrastNameStr1 = [allContrastNames{contr},'+1'];
contrastData1 = [0 0 0 1];
contrastNameStr2 =  [allContrastNames{contr},'-1'];
contrastData2 = [0 0 0 -1];
