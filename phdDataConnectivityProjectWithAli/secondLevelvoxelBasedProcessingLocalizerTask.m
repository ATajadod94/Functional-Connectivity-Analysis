function secondLevelvoxelBasedProcessingLocalizerTask
% List of open inputs
...
contrastName={'face-house-object','face-house','house-face-object','house-face'};
...
for nFolder = 1:length(contrastName)
    ...
    for n = 1:length(subjDir)
        inputs{2, 1}(n) = {[rootDir,subjDir(n).name,'\localization\con_000',num2str(nFolder),'.img']};
        % Factorial design specification: Scans - cfg_files
    end
