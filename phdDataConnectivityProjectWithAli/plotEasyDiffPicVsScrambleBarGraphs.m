function [yfam, ynfam fh sc fh_sc] = plotEasyDiffPicVsScrambleBarGraphs(isplot)
if nargin<1
    isplot=1;
end
...
if isplot==1
    ...
    plotNotBoxPlot(yfam,figDir,'easydiffEncodingHPCPPAFFA',2);
end
...
if isplot==1
    ...
    plotNotBoxPlot(ynfam,figDir,'easydiffPerceptualHPCPPAFFA',2);
end
