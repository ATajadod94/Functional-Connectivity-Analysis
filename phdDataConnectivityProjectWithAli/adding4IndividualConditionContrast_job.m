...
matlabbatch{1}.spm.stats.con.consess{2}.tcon.convec = '<UNDEFINED>';
matlabbatch{1}.spm.stats.con.consess{2}.tcon.sessrep = 'none';
matlabbatch{1}.spm.stats.con.consess{3}.tcon.name = '<UNDEFINED>';
matlabbatch{1}.spm.stats.con.consess{3}.tcon.convec = '<UNDEFINED>';
matlabbatch{1}.spm.stats.con.consess{3}.tcon.sessrep = 'none';
matlabbatch{1}.spm.stats.con.consess{4}.tcon.name = '<UNDEFINED>';
matlabbatch{1}.spm.stats.con.consess{4}.tcon.convec = '<UNDEFINED>';
