function [fam1,fam2,nonfam1,nonfam2]=creatTimeSeriesUsingRexForEncoding(subID,numTR)
...
dataDir = ['G:\myStudy\picpairfMRI\s',participantNum,...
    '\encoding\analysis_residuals\'];
% numTR = 287;
%************ fam1
f=dir([dataDir,'ResI*.img']);
for i = 1:numTR
...
save([rootDir,'encoding\','restTimeS.mat'],...
