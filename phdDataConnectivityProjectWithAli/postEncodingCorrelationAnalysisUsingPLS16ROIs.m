...
%10 rois analysis
roiIndx = [1:116]; %these index can be found in variable names 
lowTriagDataIndx = LowerTriangleIndex(length(roiIndx));
roiNames = names([1:116]); roiNames2=names2([1:116]);
...
option.clim = 95;
option.stacked_designdata = [0 1 -1; -1 0.5 0.5]'; % I only have 2 contrast
