function secondLevelRegression3PredictorsFamCond_withCov_Encoding2(isCovariate,memType)
% List of open inputs
...
for crun = 1:nrun
    inputs{1, crun} = {[rootDir,'secondLevelReg\multiRegSecondEncoding\Fam']};% Factorial design specification: Directory - cfg_files
    if ~exist([rootDir,'secondLevelReg\multiRegSecondEncoding\Fam'],'dir')
        mkdir([rootDir,'secondLevelReg\multiRegSecondEncoding\Fam']);
    end
