...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'face_house_object)';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.convec = [1 -0.5 -0.5];
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'fac_house';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.convec = [1 -1];
matlabbatch{3}.spm.stats.con.consess{2}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{3}.tcon.name = 'house_face_object)';
matlabbatch{3}.spm.stats.con.consess{3}.tcon.convec = [-0.5 1 -0.5];
matlabbatch{3}.spm.stats.con.consess{3}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{4}.tcon.name = 'house_face';
...
matlabbatch{4}.spm.stats.results.conspec(1).titlestr = 'face_house_object)';
...
matlabbatch{4}.spm.stats.results.conspec(1).extent = 5;
matlabbatch{4}.spm.stats.results.conspec(1).mask = struct('contrasts', {}, 'thresh', {}, 'mtype', {});
matlabbatch{4}.spm.stats.results.conspec(2).titlestr = 'face_house';
...
matlabbatch{4}.spm.stats.results.conspec(2).extent = 5;
matlabbatch{4}.spm.stats.results.conspec(2).mask = struct('contrasts', {}, 'thresh', {}, 'mtype', {});
matlabbatch{4}.spm.stats.results.conspec(3).titlestr = 'House_face_object)';
matlabbatch{4}.spm.stats.results.conspec(3).contrasts = 3;
matlabbatch{4}.spm.stats.results.conspec(3).threshdesc = 'none';
matlabbatch{4}.spm.stats.results.conspec(3).thresh = 0.005;
matlabbatch{4}.spm.stats.results.conspec(3).extent = 10;
matlabbatch{4}.spm.stats.results.conspec(3).mask = struct('contrasts', {}, 'thresh', {}, 'mtype', {});
matlabbatch{4}.spm.stats.results.conspec(4).titlestr = 'House_face';
matlabbatch{4}.spm.stats.results.conspec(4).contrasts = 4;
matlabbatch{4}.spm.stats.results.conspec(4).threshdesc = 'none';
matlabbatch{4}.spm.stats.results.conspec(4).thresh = 0.005;
matlabbatch{4}.spm.stats.results.conspec(4).extent = 10;
matlabbatch{4}.spm.stats.results.conspec(4).mask = struct('contrasts', {}, 'thresh', {}, 'mtype', {});
