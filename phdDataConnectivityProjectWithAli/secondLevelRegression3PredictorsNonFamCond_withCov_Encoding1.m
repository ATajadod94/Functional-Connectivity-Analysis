function secondLevelRegression3PredictorsNonFamCond_withCov_Encoding1(isCovariate,memType)
% List of open inputs
...
for crun = 1:nrun
    inputs{1, crun} = {[rootDir,'secondLevelReg\multiRegFirstEncoding\NonFam']};% Factorial design specification: Directory - cfg_files
    if ~exist([rootDir,'secondLevelReg\multiRegFirstEncoding\NonFam'],'dir')
        mkdir([rootDir,'secondLevelReg\multiRegFirstEncoding\NonFam']);
    end
