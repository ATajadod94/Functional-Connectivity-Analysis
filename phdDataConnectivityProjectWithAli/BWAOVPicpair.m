function [P1 P2 P3 effectSize] = BWAOVPicpair(X,alpha)
%zhongxu change without output anava table
...
effectSize.eta3 = SSAB/(SSAB +SSEAB);
effectSize.eta2 = SSAB/(SSB +SSEAB);
effectSize.eta1 = SSAB/(SSA +SSEA);
return;