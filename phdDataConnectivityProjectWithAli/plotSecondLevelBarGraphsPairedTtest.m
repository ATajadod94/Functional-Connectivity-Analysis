function plotSecondLevelBarGraphsPairedTtest(famDir, figDir,figName)
...
%     
% end
dataL=yfam(1:2:40,1:2:10)-yfam(2:2:40,1:2:10);
 [a b c d]=ttest(dataL,0)
dataR=yfam(1:2:40,2:2:10)-yfam(2:2:40,2:2:10);
    [a b c d]=ttest(dataR,0)
my_barvalues = [mean(dataL);mean(dataR)];

my_errors =  [std(dataL)/sqrt(20);std(dataR)/sqrt(20)];
plotBarFig(my_barvalues',my_errors',figName,myFontSize,'beta',figDir,[8,5]);
