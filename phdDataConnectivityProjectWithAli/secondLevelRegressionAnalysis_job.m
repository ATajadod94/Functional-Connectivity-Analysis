...
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(1).c = '<UNDEFINED>';
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(1).cname = '<UNDEFINED>';
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(1).iCC = 1;
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(2).c = '<UNDEFINED>';
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(2).cname = '<UNDEFINED>';
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(2).iCC = 1;
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(3).c = '<UNDEFINED>';
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(3).cname = '<UNDEFINED>';
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(3).iCC = 1;
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(4).c = '<UNDEFINED>';
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(4).cname = '<UNDEFINED>';
