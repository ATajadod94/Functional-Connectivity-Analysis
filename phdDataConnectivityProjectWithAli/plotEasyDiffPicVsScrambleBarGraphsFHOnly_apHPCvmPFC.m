function [yfam, fh] = plotEasyDiffPicVsScrambleBarGraphsFHOnly_apHPCvmPFC(condName,isplot)
if nargin<2
    isplot=1;
end
famDir = ['C:\Users\Zhongxu\Documents\myStudy\picpairfMRI\secondLevelPmodAnalysis\',condName,'\famnfam12\'];
...
% if isplot==1
%     plotBarFig(my_barvalues',my_errors',condName,myFontSize,'beta',figDir,[8,5]);
%     plotNotBoxPlot(yfam,figDir,condName,2);
% end
