function SecondLevelEncodingROIMarsbarAnalysis
...
contrastDirs = dir('C:\Users\Zhongxu\Documents\myStudy\picpairfMRI\secondLevelGMOnlyAnalysis');
contrastDirs = contrastDirs(3:end);
% Subdirectory for reconfigured design
rootDir = 'C:\Users\Zhongxu\Documents\myStudy\picpairfMRI\secondLevelGMOnlyAnalysis\';

for j = 1: size(contrastDirs,1)
    contrastDir = [rootDir, contrastDirs(j).name];
    ...
    for i = 1:10
        ...
        if j ==1
            saveroi(o, fullfile(maskDir,[rois{i}(1:5),'-roi.mat']));
        end
