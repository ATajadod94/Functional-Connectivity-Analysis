...
rootfolder='/Volumes/Ryan3T1/myStudies/phdThesisData/Data/Conn_Tasks_inf_output_quicktest_5';
...
for i = 1: nsubj
batch.Setup.functionals{i} =  Getting_labels('function' ,i, 'tasks')';
end
for i = 1: nsubj
...
%% DENOISE / PREPROCESS
batch.Denoising.filter=[.008, inf];           % FOR TASKS DO [.008, INF], FOR RUN RES do  [.008, .1];
